...
namespace PaginaOnePiece.Models;
    ...
    {
<<<<<<< HEAD
        private static string _connectionString = @"Server=A-PHZ2-CIDI-033\SQLEXPRESS;DataBase = OnePiece;Trusted_Connection=True;";
=======
        private static string _connectionString = @"Server=A-PHZ2-CIDI-034\;DataBase=OnePiece;Trusted_Connection=True;";
>>>>>>> abd4a477fae3bbaed94844148c63177c628a5f1a
